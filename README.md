# Análisis de Algoritmos — Grupo 14

**ITM · 2026-2 · Actividades grupales**

Este repositorio agrupa las actividades del curso. Cada una vive en su propia carpeta; entra al README de la actividad para ver descripción, cómo ejecutarla y la documentación.

| Actividad | Carpeta | Tema |
|-----------|---------|------|
